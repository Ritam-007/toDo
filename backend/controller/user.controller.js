...
import { z } from 'zod';
 // zod is a library for emain, password validation. Means if there are no "@" in the email and is there are less than 3 characters is the password, then the email and password is invalid.
